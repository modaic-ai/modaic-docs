...
from retrievers.databases.vector_database import VectorDatabase, MilvusBackend
...
from retrievers.context.text import Text
from modaic.precompiled_program import PrecompiledConfig
from modaic.retrievers.base import Indexer
from retrievers.databases.vector_database import VectorDatabase, MilvusBackend
from retrievers.indexing import DummyEmbedder
...
```python
from modaic.auto_program import AutoRetriever
...
- Precompiled DSPY Programs for a similar packaging pattern
